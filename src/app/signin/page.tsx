...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#121c2b] flex items-center justify-center font-sans antialiased p-[40px] selection:bg-[#635bff]/20">
      ...
      {/* Main Container */}
      <main className="relative z-10 w-full max-w-[420px] mx-auto flex flex-col gap-[40px]">
        {/* Header */}
