...
const ChatboxDemo = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center p-4 font-sans text-text-100 transition-colors duration-200">

            {/* Greeting Section */}
            <div className="w-full max-w-3xl mb-8 sm:mb-12 text-center animate-fade-in">
                <div className="w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                    <img src="https://images.unsplash.com/photo-1620825937374-87fc7d62828e?q=80&w=256&auto=format&fit=crop" alt="Logo" className="w-16 h-16 rounded-full object-cover shadow-lg" />
                </div>
